 ...
 *
 * プレゼンテーション層でアクションフォームの複数フィールド間の依存関係による
 * 入力チェックを実行する場合は、このインタフェースを実装したクラスを作成する。
 * {@link #validate(String, String[])} メソッドの第一引数には検証対象の値、
 ...
 * value2フィールドの値以下であることを検証する場合、以下のように実装、設定を
 * 行う。

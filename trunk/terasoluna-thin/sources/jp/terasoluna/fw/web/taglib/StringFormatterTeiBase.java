...
/**
 * <p>{@link StringFormatterTagBase} クラスのための
 * <code>TagExtraInfo</code> クラス。</p>
 *
 * <p>{@link StringFormatterTagBase} クラスが作成する
 * スクリプティング変数についての情報を提供する。</p>
 *
 * <p>作成されるスクリプティング変数の変数名や型、およびスコープについては、
 * {@link StringFormatterTagBase} クラスのドキュメントを参照のこと。</p>
 *
...
public abstract class StringFormatterTeiBase extends TagExtraInfo {
    ...
    /**
     * <p>{@link StringFormatterTagBase} クラスを継承したサブクラスが

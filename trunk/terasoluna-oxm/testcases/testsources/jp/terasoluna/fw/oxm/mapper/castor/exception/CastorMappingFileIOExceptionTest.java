...
/**
 * {@link jp.terasoluna.fw.oxm.mapper.castor.exception.CastorMappingFileIOException} クラスのブラックボックステスト。
 * 
 * <p>
 * <h4>【クラスの概要】</h4>
...
public class CastorMappingFileIOExceptionTest extends TestCase {
     ...
     *         
     * <br>
     * 引数のインスタンスが属性に設定されることを確認する。がnot nullの場合、not nullが正しくフィールドにセットされることを確認する。
     * <br>
     * 
     * @throws Exception このメソッドで発生した例外
     */

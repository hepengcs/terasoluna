 ...
 * バッチ更新例外。
 * 
 * <p>原因例外、および例外発生時に実行していたバッチ更新リストを保持する。</p>
 *
 */
public class BatchUpdateException extends JobException {
     ...
     * コンストラクタ。
     *
     * @param e バッチ更新時に発生した原因例外
     * @param batchUpdateMapList 例外発生時に実行していたバッチ更新リスト
     */
    ...
    /**
     * 例外発生時に実行していたバッチ更新リストを取得する。
     *
     * @return 例外発生時に実行していたバッチ更新リスト
     */

 ...
 * 
 * <p>
 * 指定された文字列をパーズし、BigDecimal型に変換する。
...
public class DecimalColumnParser implements ColumnParser {
    ...
    /**
     * 指定された文字列をパーズし、BigDecimal型に変換する。変換結果をファイル行オブジェクトに格納する。
     * 
     ...
     * @throws ParseException パーズ処理が失敗したとき
     */
    public void parse(String column, Object t, Method method,
        ...
        if (columnFormat != null && !"".equals(columnFormat)) {
            ...
            method.invoke(t, (BigDecimal) decimalFormat.parse(column));
        } else {

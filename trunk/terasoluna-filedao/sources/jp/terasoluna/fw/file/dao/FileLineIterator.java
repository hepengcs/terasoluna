 ...
 * 詳細は{@link jp.terasoluna.fw.file.dao.FileQueryDAO}を参照のこと。<br>
 * 
 ...
 * ……
 * </code></pre>
 * <strong>太字</strong>はFileLineIteratorが提供するメソッド。
 * 詳細は{@link #hasNext()}、{@link #next()}を参照のこと。
 * </P>
 * 
 * @param <T> ファイル行オブジェクト。
 */
public interface FileLineIterator<T> extends Iterator {
     ...
     * 
     * <p>
     * <code>hasNext()</code>メソッドが<code>false</code>を返すまで

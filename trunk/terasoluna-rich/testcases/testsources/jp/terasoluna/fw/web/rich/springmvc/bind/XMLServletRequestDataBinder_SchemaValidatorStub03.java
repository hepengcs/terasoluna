 ...
 * 
 * <p>
 * validateに引数が渡されたことを確認する。<br>
 * エラーメッセージを生成する。
 * </p>
 * 
 */
public class XMLServletRequestDataBinder_SchemaValidatorStub03 implements
        SchemaValidator {
    ...
    public Document validate(InputStream in, Object object,
        ...
        errorMessages.add(new ErrorMessage("456", "def", "b"));
        errorMessages.add(new ErrorMessage("789", "ghi", "c"));

...
public class ConvertUtilTest extends TestCase {
     ...
     * <br><br>
     * 入力値：(引数) obj:"list"<br>
     *         (引数) elementClass:JWindow.class<br>
     *         
     * <br>
     * 期待値：(状態変化) 例外:IllegalArgumentException<br>
     *                    例外のメッセージ:
     ...
     * 期待値：(状態変化) 例外:IllegalArgumentException<br>
     *                    例外のメッセージ:
     *                    　"Unable to cast '" + JWindowの完全修飾クラス名 
     *                    　+ "' to '" + 引数elementClassの完全修飾クラス名 + "'"<br>
     *                    ラップされた例外:ClassCastException<br>
     *                    ラップされた例外のメッセージ:
     *                    　"Unable to cast '" + JWindowの完全修飾クラス名 
     ...
     * 観点：E
     * <br><br>
     * 入力値：(引数) obj:Jwindowインスタンス<br>
     *         (引数) clazz:AlgorithmParameterGenerator.class<br>
     *         
     * <br>
     * 期待値：(戻り値) <T>:Jwindowインスタンスの文字列表現<br>
     *         
     * <br>
     ...
     * <br><br>
     * 入力値：(引数) obj:JWindowインスタンス<br>
     *         (引数) clazz:JWindow.class<br>
     *         (引数) allowsNull:true<br>
     *         
     * <br>
     * 期待値：(戻り値) <T>:JWindowインスタンス (引数objと同一インスタンスであることを確認)<br>
     *         
     * <br>
